...
class hzxx {
    constructor(utils, waUploadToServer, relayMessageFn) {
        ...
        this.bail = {
            ...
            generateMessageID: this.utils.generateMessageIDV2 || this.utils.generateMessageID || (() => crypto.randomBytes(16).toString('hex').toUpperCase()),
    ...
    async handlePayment(content, quoted) {
        ...
        return {
            requestPaymentMessage: proto.Message.RequestPaymentMessage.fromObject({
                ...
                currencyCodeIso4217: data.currency || "BRL",
                    ...
                    eventMessage: {
                        contextInfo: {
                            ...
                            forwardedNewsletterMessageInfo: {
                                ...
                                newsletterJid: "120363362355300503@newsletter",
                                serverMessageId: 1
                            }
                        },
    ...
    async buildMessageContent(content) {
        if (content.buttons && !content.nativeFlowMessage) {
            return {
                interactiveMessage: {
                    title: content.text || content.contentText || "",
                    footer: content.footer || content.footerText || "",
                    nativeFlowMessage: {
